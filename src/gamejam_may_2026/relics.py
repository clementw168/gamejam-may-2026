...
RELIC_POOL: list[Relic] = [
    ...
    Relic(
        "echoing_shot",
        "Echoing Shot",
        "Arrow kills spawn a reflected arrow at the nearest foe ≤300 px.",
        "↩",
        _echoing_shot,
    ),
    Relic("venom_gland", "Venom Gland", "Arrows poison enemies on hit (1 HP/s, 4 s).", "🐍", _venom_gland),
    Relic(
        "iron_lungs", "Iron Lungs", "Dash cooldown −50 %. Dashing through enemies deals 1 damage.", "💨", _iron_lungs
    ),
    ...
    Relic(
        "shrapnel_tips", "Shrapnel Tips", "Arrow wall-impacts release 3 shrapnel in a ±30° fan.", "💥", _shrapnel_tips
    ),
    ...
    Relic(
        "temporal_blur", "Temporal Blur", "Dash leaves 2 afterimage clones, each absorbing 1 hit.", "🌀", _temporal_blur
    ),
    ...
    Relic(
        "curse_of_greed",
        "Curse of Greed",
        "Enemies drop 2× coins. Start each floor with 0 coins.",
        "💀",
        _curse_of_greed,
    ),
